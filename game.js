...
var Game = function (iCanvas, iNom) {
    ...
    this.Resources.Images.push(new ImageProvider("fleche.png"));//8
    ...
    this.Animate = function () {
        me.Data.LastChange++;
        if (me.Data.LastChange >= me.Data.NextChange) {
            me.Data.LastChange = 0;
            me.Data.NextChange *= 0.9;
            if (me.Data.NextChange < 400) {
                me.Data.NextChange = 400;
            }
            var AxeX = Math.round(Math.random() * 2) - 1;
            if (AxeX == 0)
                var AxeY = 2 * Math.round(Math.random()) - 1;
            else
                var AxeY = 0;

            me.Data.UserBoule.sGravite.x = 0.25 * AxeX;
            me.Data.UserBoule.sGravite.y = 0.25 * AxeY;
    ...
    this.Render = function () {
        ...
        if (me.Data.UserBoule.sGravite.y >0) {
            ctx.rotate(Math.PI);
        }
        else if (me.Data.UserBoule.sGravite.x > 0) {
        ...
        ctx.drawImage(me.Resources.Images[8].base, -25, -25);
        ctx.restore();
